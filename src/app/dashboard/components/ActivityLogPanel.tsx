  ...
  return (
    <>
      ...
      <button
        ...
        className="hidden md:flex fixed bottom-6 right-6 z-40 items-center gap-2 bg-gray-900 text-white px-3 py-2 rounded-full shadow-lg hover:bg-gray-700 transition-colors text-[12px] font-bold"
      >
